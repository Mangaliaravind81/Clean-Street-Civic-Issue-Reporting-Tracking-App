...
//     if((role==="Public" || role==="admin") && !email.endsWith("@gmail.com")){
//       setLoading(false);
...
//         <input className="border w-full p-2 mt-4"
//           placeholder="Email"
//           value={email}
//           onChange={e=>setEmail(e.target.value)}
//         />

//         <input className="border w-full p-2 mt-3"
//           type="password"
...
//         <select className="border w-full p-2 mt-3"
//           value={role}
...
//         <button className="bg-green-600 text-white w-full mt-4 p-2">
//           {loading?"Signing in...":"Login"}
//         </button>

//         <Link to="/register" className="block text-center mt-3 text-green-600">
//           Register
//         </Link>
