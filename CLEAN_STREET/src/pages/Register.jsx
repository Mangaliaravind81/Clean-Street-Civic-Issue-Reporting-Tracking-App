...
// //     if ((form.role === "Public" || form.role === "admin") && !form.email.endsWith("@gmail.com")) {
// //       alert("public Or admin users must use @gmail.com");
// //       return;
// //     }

// //     if (form.password !== form.confirmpassword) {
// //       alert("Both password & confirm must be same");
// //       return;
// //     }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-10">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Input label="Phone (optional)" placeholder="Enter phone"
            value={form.phone}
            onChange={(e) => update("phone", e.target.value)}
          />
          ...
          <Input label="Confirm Password" type="password" placeholder="Same password"
            value={form.confirmpassword}
            onChange={(e) => update("confirmpassword", e.target.value)}
          />
