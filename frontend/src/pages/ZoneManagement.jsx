          ...
          <div className="flex justify-between items-center mb-10">
            <div>
              ...
              <p className="text-gray-500">
                Define and monitor administrative districts
              </p>
            </div>
            <button
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setNewZone({
                          ...newZone,
                          boundary_coords: e.target.value,
                        })
                      }
            ...
            {zones.map((z) => (
              ...
              >
                ...
                <p className="text-gray-500 text-sm mb-6 leading-relaxed">
                  {z.description ||
                    "No description provided for this administrative zone."}
                </p>
            ...
            {zones.length === 0 && !showAdd && (
              <div className="col-span-full py-20 bg-white rounded-3xl border border-dashed border-gray-200 text-center">
                ...
                <p className="text-gray-400 font-medium">
                  No zones defined yet. Start by adding one from the button
                  above.
                </p>
              </div>
            )}
