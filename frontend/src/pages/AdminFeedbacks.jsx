...
const faqs = [
  {
    ...
    answer:
      "Go to the 'Report Issue' page, fill in the details like title, description, and location, and upload a photo if possible. Click submit to register your complaint.",
  },
  {
    question: "How are volunteers assigned?",
    answer:
      "Currently, administrators can manually assign registered volunteers to nearby issues from the Manage Complaints page.",
  },
  {
    question: "What happens when an issue is resolved?",
    answer:
      "The user who reported the issue will see its status updated to 'Resolved' and can then provide feedback and a star rating for the responsible volunteer.",
  },
  {
    question: "Can I delete a complaint?",
    answer:
      "Public users can delete their own complaints from the View Complaints page. Admins can delete any complaint if it violates guidelines.",
  },
];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-h-[800px] overflow-y-auto pr-2">
                  {volunteerFeedbacks.length === 0 ? (
                    <p className="text-gray-500">
                      No complaint feedback received yet.
                    </p>
                  ) : (
                    volunteerFeedbacks.map((fb) => (
                      <div
                        key={fb._id}
                        className="bg-gray-50 p-5 rounded-xl border border-gray-200 flex flex-col justify-between"
                      >
                        {/* Complaint Card */}
                        <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 mb-4 flex flex-col sm:flex-row gap-4">
                          {fb.complaint_id?.photo &&
                          ...
                          <div className="flex-1">
                            <div className="flex justify-between items-start gap-2">
                              <h3 className="font-bold text-lg text-gray-800 line-clamp-1">
                                {fb.complaint_id?.title || "Unknown Complaint"}
                              </h3>
                              <span className="bg-gray-200 text-gray-700 px-2 py-1 rounded text-[10px] font-bold uppercase flex-shrink-0">
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-sm border border-green-100 border-l-4 border-l-green-500 relative">
                          ...
                          <h4 className="font-bold text-green-800 mb-2 text-sm uppercase tracking-wide">
                            Resolution Feedback
                          </h4>
              ...
              {loading ? (
                ...
                <div className="space-y-4 max-h-[600px] overflow-y-auto pr-2">
                  {appFeedbacks.length === 0 ? (
                    <p className="text-gray-500">
                      No application feedback received yet.
                    </p>
                  ) : (
                    appFeedbacks.map((fb) => (
                      <div
