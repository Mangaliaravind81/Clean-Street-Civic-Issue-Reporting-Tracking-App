            ...
            <div className="relative mb-6">
              ...
              <div
                ...
                onClick={() => {
                  ...
                  else if (user?.profile_photo && !removePhoto)
                    setFullScreenImage(user.profile_photo);
                }}
              >
                {photoPreview ? (
                  <img
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div className="flex-1">
                      <h4 className="font-bold text-gray-900 mb-1 flex items-center gap-2">
                        <FaMapMarkerAlt className="text-blue-500" /> HQ
                        Proximity Location
                      </h4>
                      <p className="text-sm text-gray-400 font-medium italic">
                        Click markers or use "Capture GPS" to set your base of
                        operations.
                      </p>
                      <div className="mt-2 flex gap-2">
                        <span className="text-[10px] font-bold bg-blue-50 text-blue-600 px-2 py-1 rounded-md uppercase border border-blue-100 shadow-sm">
                          LAT:{" "}
                          {formData.location_coords?.split(",")[0] || "---"}
                        </span>
                        <span className="text-[10px] font-bold bg-blue-50 text-blue-600 px-2 py-1 rounded-md uppercase border border-blue-100 shadow-sm">
                          LNG:{" "}
                          {formData.location_coords?.split(",")[1] || "---"}
                        </span>
                      </div>
                    </div>
                          ...
                          if (navigator.geolocation) {
                            navigator.geolocation.getCurrentPosition(
                              (pos) => {
                                setFormData({
                                  ...formData,
                                  location_coords: `${pos.coords.latitude},${pos.coords.longitude}`,
                                });
                              },
                    ...
                    <div className="h-80 w-full rounded-2xl overflow-hidden border-2 border-blue-50 relative group">
                      <MapComponent
                        onLocationChange={(loc) =>
                          setFormData({
                            ...formData,
                            location_coords: `${loc.lat},${loc.lng}`,
                          })
                        }
                      />
          ...
          <div className="bg-white rounded-[2rem] w-full max-w-md p-8 shadow-2xl relative">
            <div className="mb-6">
              ...
              <p className="text-gray-400 text-sm font-medium italic">
                Your data and visibility overview
              </p>
            </div>
            ...
            <div className="space-y-5">
              <div className="p-5 bg-blue-50/50 rounded-2xl border border-blue-100">
                ...
                <p className="text-sm text-gray-500 font-medium leading-relaxed">
                  Your email address and phone number are completely hidden from
                  the public. They are only accessible to administrators to help
              ...
              <div className="p-5 bg-emerald-50/50 rounded-2xl border border-emerald-100">
                ...
                <p className="text-sm text-gray-500 font-medium leading-relaxed">
                  Your location is never tracked in the background. Geolocation
                  is only captured exactly when you choose to report an issue or
                  capture a proximity location.
                </p>
              </div>
