      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <Link
              to="/report"
              className="block bg-green-600 text-white text-center py-2 rounded mb-3"
            >
              Report New Issue
            </Link>
            ...
            <Link
              to="/community"
              className="block border py-2 rounded text-center mb-3"
            >
              Browse Community
            </Link>
            ...
            <Link
              to="/profile"
              className="block border py-2 rounded text-center"
            >
              View Profile
            </Link>
          </div>
