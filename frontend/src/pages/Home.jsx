...
//       Make Your City{" "}
//       <span className="text-green-500">Clean & Green</span>
//     </h1>
...
//           {["Garbage", "Potholes", "Street Lights", "Water Issues"].map(
//             (item) => (
//               <div
//                 key={item}
...
//         <NavLink to="/register" className="inline-block mt-6 bg-white text-green-700 px-6 py-3 rounded-lg">
//             Start Now →
//         </NavLink>
