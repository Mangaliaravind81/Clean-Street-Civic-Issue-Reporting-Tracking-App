        ...
        complaints.map((c) => {
          if (c._id === id) {
            const matchedVol = volunteers.find(
              (v) => String(v._id) === String(volunteer_id),
            );
            return {
              ...res.data.complaint,
              assigned_to: matchedVol || res.data.complaint.assigned_to,
            };
          }
          return c;
        }),
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="flex lg:h-[calc(100vh-64px)] overflow-hidden">
          ...
          <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center mb-10 gap-4">
            <div>
              ...
              <p className="text-gray-500">
                Monitor, assign, and resolve community issues
              </p>
            </div>
        ...
        {nearbyModal &&
          (() => {
            const [cLat, cLng] = nearbyModal.location_coords
              .split(",")
              .map(Number);
